    ...
    <aside className="w-64 h-screen bg-black text-white flex flex-col justify-between p-4">
      ...
      <div>
        ...
        <nav className="space-y-4">
          ...
          <Link to="/about" className="flex items-center gap-3 px-2 py-2 hover:bg-zinc-800 rounded cursor-pointer">
          ...
          <Link to="/skills" className="flex items-center gap-3 px-2 py-2 hover:bg-zinc-800 rounded cursor-pointer">
            <BadgeCheck className="w-5 h-5" />
            <span>Skills</span>
          </Link>
          <Link to="/blog" className="flex items-center gap-3 px-2 py-2 hover:bg-zinc-800 rounded cursor-pointer">
            <PenSquare className="w-5 h-5" />
            <span>Blog</span>
          </Link>
          <Link to="/experience" className="flex items-center gap-3 px-2 py-2 hover:bg-zinc-800 rounded cursor-pointer">
